...
| `dailytop:coder-ls291-0.0.1` | no | **deployments** |
| `dailytop:coder-unpriv` | yes | trying the unprivileged build |
| `dailytop:coder-unpriv-ls291-0.0.1` | no | **unprivileged deployments** |
| `dailytop:k8s` | yes | trying the GPU build |
| `dailytop:k8s-ls291-0.0.1` | no | **GPU deployments** |
...
`fedora-kde-e46b460a-ls291` → `ls291`) and the version is the git tag verbatim. The full
...
appVersion `<lsNNN>-<version>` — `ls291-0.0.1`. The chart composes its default image tag
